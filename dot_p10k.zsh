# Generated by Powerlevel10k configuration wizard on 2024-07-30 at 10:14 CEST.
...
# round separators, round heads, blurred tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=014
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=014
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=014
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=014
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=014
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=014
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=014
  # Custom icon.
